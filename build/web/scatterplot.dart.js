...
var dart=[["","",,F,{
"^":"",
X:function(a,b){return W.Kn(a,null,null).ml(new F.jT(b))},
...
a[y]=z
return a},
lm:function(a){if(a!=null)return P.T(["floor",new F.cK(a),"ceil",new F.hf(a)])
return $.MX()},
jT:{
"^":"r:0;Q",
...
s=F.rV(u,t,v[2])}else s=x.Q
r=z.xE(".tick").ob(0,s)
q=y.r
q=q!=null?q:new F.tJ()
p=new F.fu(r,r.b).Y(0,"g")
o=F.wW(r)
p.Z("class","tick")
n=F.va(x)
m=z.xE(".domain").ob(0,[0])
l=new F.fu(m,m.b).Y(0,"path")
l.Z("class","domain")
p.Y(0,"line")
p.Y(0,"text")
k=p.Nm(0,"line")
...
g.Z("y",P.u(w,0)+u)
i.Z("dy",".71em")
new F.M(i).spj("middle")
if(0>=n.length)return H.e(n,0)
y=y.c
u="M"+H.d(n[0])+","+y+"V0H"
if(1>=n.length)return H.e(n,1)
l.Z("d",u+H.d(n[1])+"V"+y)}else if(w==="top"){f=y.gZ7()
w=y.b
u=-w
k.Z("y2",u)
y=y.d
...
g.Z("y",-(P.u(w,0)+y))
i.Z("dy","0em")
new F.M(i).spj("middle")}else{u=y.b
t=y.d
e=y.c
if(w==="left"){f=y.gcD()
y=-u
...
t=t+H.d(n[0])+"H0V"
if(1>=n.length)return H.e(n,1)
l.Z("d",t+H.d(n[1])+"H"+e)}else{f=y.gcD()
k.Z("x2",u)
h.Z("x",P.u(u,0)+t)
j.Z("x2",u)
j.Z("y2",0)
...
return z.$1(new H.Zo(v,null))}}if(a instanceof TypeError){u=$.YC()
t=$.OI()
s=$.PH()
r=$.D1()
q=$.rx()
...
if(typeof x!=="number")return H.o(x)
u=500-w-x
t=new F.P([0,1],[0,1],F.Em(),!1,null,null)
t.Oi()
t.a=[0,v]
t.Oi()
...
s.Oi()
x=$.O()
r=new F.G3([],null,null,null,P.V())
r.a=x
q=new F.L(null,"bottom",6,6,3,[10],null,null)
q.Q=t
q.a="bottom"
q.r=new M.Q()
p=new F.L(null,"bottom",6,6,3,[10],null,null)
p.Q=s
p.a="left"
o=F.Y(document.querySelector("body")).Y(0,"svg")
z.Q=o
x=y.p(0,"left")
if(typeof x!=="number")return H.o(x)
w=y.p(0,"right")
...
o=o.Y(0,"g")
z.Q=o
o.Z("transform","translate("+H.d(y.p(0,"left"))+","+H.d(y.p(0,"top"))+")")
F.X("scatterplot.tsv","\t").ml(new M.em(z,v,u,t,s,r,q,p))},"$0","EC",0,0,13],
Q:{
"^":"r:25;",
$2:function(a,b){return J.r0(a,1)}},
em:{
...
v=w.Q.Y(0,"g")
v.Z("class","x axis")
v.Z("transform","translate(0,"+this.b+")")
v.$1(this.f)
u=v.Y(0,"text")
u.Z("class","label")
y=this.a
...
u.Z("y",-6)
new F.M(u).spj("end")
u.sa4(0,"Sepal Width (cm)")
t=w.Q.Y(0,"g")
t.Z("class","y axis")
t.$1(this.r)
u=t.Y(0,"text")
u.Z("class","label")
u.Z("transform","rotate(-90)")
u.Z("y",6)
u.Z("dy",".71em")
new F.M(u).spj("end")
u.sa4(0,"Sepal Length (cm)")
s=w.Q.xE(".dot").ob(0,a)
r=new F.fu(s,s.b).Y(0,"circle")
r.Z("class","dot")
r.Z("r",3.5)
r.c3("cx",new M.oZ(z))
r.c3("cy",new M.y8(x))
x=this.e
new F.M(r).MW(0,"fill",new M.Hi(x))
w=w.Q.xE(".legend").ob(0,x.gBr(x))
q=new F.fu(w,w.b).Y(0,"g")
q.Z("class","legend")
q.c3("transform",new M.BT())
w=q.Y(0,"rect")
w.Z("x",y-18)
w.Z("width",18)
w.Z("height",18)
new F.M(w).MW(0,"fill",new M.PY(x))
p=q.Y(0,"text")
p.Z("x",y-24)
p.Z("y",9)
p.Z("dy",".35em")
...
U:{
"^":"r:3;",
$2:function(a,b){return J.Tf(a,"sepalWidth")}},
VW:{
"^":"r:3;",
$2:function(a,b){return J.Tf(a,"sepalLength")}},
oZ:{
"^":"r:3;Q",
$2:function(a,b){return this.Q.$1(J.Tf(a,"sepalWidth"))}},
y8:{
"^":"r:3;Q",
$2:function(a,b){return this.Q.$1(J.Tf(a,"sepalLength"))}},
Hi:{
"^":"r:3;Q",
$2:function(a,b){return"#"+J.Gw(this.Q.$1(J.Tf(a,"species")),16)}},
BT:{
"^":"r:3;",
$2:function(a,b){return"translate(0,"+b*20+")"}},
PY:{
"^":"r:3;Q",
$2:function(a,b){return"#"+J.Gw(this.Q.$1(a),16)}},
u8:{
"^":"r:3;",
$2:function(a,b){return a}}},1]]
setupProgram(dart,0)
...
var w=a[y+1]
var v=a[y+2]
I.$lazy(x,w,v)}})(["ir","Ai",function(){return P.aa("__data__")},"BM","Xw",function(){return P.tM(C.yT,null)},"tu","MX",function(){return P.T(["floor",new F.wJ(),"ceil",new F.zO()])},"W","O",function(){return[2062260,16744206,2924588,14034728,9725885,9197131,14907330,8355711,12369186,1556175]},"Kb","Rs",function(){return H.Td()},"rS","p6",function(){return P.aa(null)},"U2","YC",function(){return H.cM(H.S7({toString:function(){return"$receiver$"}}))},"k1","OI",function(){return H.cM(H.S7({$method$:null,toString:function(){return"$receiver$"}}))},"Re","PH",function(){return H.cM(H.S7(null))},"fN","D1",function(){return H.cM(function(){var $argumentsExpr$='$arguments$'
...
try{(void 0).$method$($argumentsExpr$)}catch(z){return z.message}}())},"BX","W6",function(){return H.cM(H.Mj(null))},"tt","Bi",function(){return H.cM(function(){try{null.$method$}catch(z){return z.message}}())},"dt","eA",function(){return H.cM(H.Mj(void 0))},"A7","ko",function(){return H.cM(function(){try{(void 0).$method$}catch(z){return z.message}}())},"lI","ej",function(){return P.Oj()},"xg","xb",function(){return[]},"fd","pJ",function(){return{}}])
I=I.$finishIsolateConstructor(I)
$=new I()
init.metadata=[null]
init.types=[{func:1,args:[P.I]},{func:1,void:true,args:[P.EH]},{func:1,args:[W.cv,,P.KN],opt:[P.KN]},{func:1,args:[,,]},{func:1,args:[F.j4]},{func:1,args:[P.a]},{func:1,args:[,]},{func:1,ret:P.a,args:[,]},{func:1,ret:P.a,args:[P.a]},{func:1,void:true,args:[,,]},{func:1,void:true,args:[F.Hv]},{func:1,args:[,P.KN]},{func:1},{func:1,void:true},{func:1,args:[,P.I]},{func:1,args:[{func:1,void:true}]},{func:1,void:true,args:[P.a],opt:[P.Gz]},{func:1,void:true,args:[,],opt:[P.Gz]},{func:1,args:[,],opt:[,]},{func:1,ret:P.a2},{func:1,args:[,P.Gz]},{func:1,void:true,args:[,P.Gz]},{func:1,args:[P.wv,,]},{func:1,ret:P.I,args:[P.KN]},{func:1,args:[W.zU]},{func:1,args:[P.FK,,]},{func:1,args:[P.zM]},{func:1,ret:{func:1,ret:P.a,args:[P.a]},args:[P.FK,P.FK]},{func:1,ret:P.EH,args:[,,,,]},{func:1,void:true,args:[{func:1,void:true}]},{func:1,void:true,args:[,]},{func:1,ret:P.a2,args:[,,]},{func:1,ret:P.KN,args:[,]},{func:1,ret:P.a2,args:[P.a,P.a]},{func:1,ret:P.KN,args:[P.a]}]
...
if(typeof dartMainRunner==="function")dartMainRunner(function(b){H.Rq(M.EC(),b)},[])
else (function(b){H.Rq(M.EC(),b)})([])})})()